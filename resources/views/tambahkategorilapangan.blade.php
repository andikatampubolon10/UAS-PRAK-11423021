            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Tambah Kategori Lapangan</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form name="tambahkategorilapangan" method="post" action="{{route('tambahkategorilapangan.store')}}" enctype="multipart/form-data">
                @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama Lapangan</label>
                      <input name="namalapangan" type="text" class="form-control" id="exampleInputPassword1" placeholder="Nama Lapangan">
                    </div>
                    <div class="form-group">
                      <label for="waktututup">Waktu Buka</label>
                      <input name="waktu_buka" type="time" class="form-control" id="waktubuka" required>
                    </div>
                    <div class="form-group">
                      <label for="waktututup">Waktu Tutup</label>
                      <input name="waktu_tutup" type="time" class="form-control" id="waktututup" required>
                    </div>
